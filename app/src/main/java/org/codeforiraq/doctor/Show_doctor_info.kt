...
class Show_doctor_info : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nav_info.setNavigationItemSelectedListener(this)
        var actionToggle = ActionBarDrawerToggle(this,drow_info,toolbar_main,R.string.drawe_open,R.string.drawe_close)


        drow_info.addDrawerListener(actionToggle)
    ...
    fun closenavigation (){
        ...
        drow_info.closeDrawer(Gravity.START)
    }

    override fun onBackPressed() {
        if (drow_info.isDrawerOpen(GravityCompat.START)) {
